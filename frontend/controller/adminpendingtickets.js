angular.module('stock').controller('adminpendingtickets',function($scope,$http,$timeout,$filter,$cookies,$window,$route,$rootScope,apiurl){
	...
	$scope.totaltikets = ()=>{
		$http.get(apiurl+"TicketMaster/TotalTicketDatainAssets").success(function(data){
			...
			let filterdata = data.filter(e=>e.ticketStatusTitle=='PARTREQUIRED' || e.ticketStatusTitle=='REPLACEMENT' || e.ticketStatusTitle=='SERVICE SENT' || e.ticketStatusTitle=='Follow Up - Level 1' || e.ticketStatusTitle=='Follow Up - Level 2')
